...
(function() {
        const app = {
            ...
            doDown: function(e) {
                ...
                app.state.lastPos = {x:e.clientX,y:e.clientY};
...
//                if (app.state.lastPos.x < e.x) {
                ...
                //    if (theta < 0) theta = 360 - theta;
                    ...
                    l.style.width = len + 'px';
/*                } else {
                    dx = e.x - app.state.lastPos.x;
                    dy = e.y - app.state.lastPos.y;
            ...
            doUp: function(e) {
                ...
                if (chk) {
                    ...
                    $(`#player${app.state.currentPlayer}Words`).innerHTML += `<div class='found'>${chk} [${app.state.currentWordScore}]</div>`;
